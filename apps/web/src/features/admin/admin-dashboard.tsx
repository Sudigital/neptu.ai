    ...
    <Main>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={isLoading ? "..." : (stats?.stats.subscriptions.active ?? 0)}
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Potensi</span>
                <span className="font-medium">
                  {stats?.stats.readings.potensi ?? 0}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Peluang</span>
                <span className="font-medium">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold">
                  {stats?.stats.usage.totalCreditsUsed?.toLocaleString() ?? 0}
                </div>
                <div className="text-sm text-muted-foreground">
                  Credits Used
                </div>
