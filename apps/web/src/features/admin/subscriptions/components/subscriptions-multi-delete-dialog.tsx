...
type SubscriptionsMultiCancelDialogProps<TData> = {
  open: boolean;
...
export function SubscriptionsMultiCancelDialog<TData>({
  open,
  onOpenChange,
  table,
    ...
    <ConfirmDialog
      ...
      desc={
        <div className="space-y-4">
          <p className="mb-2">
            Are you sure you want to cancel the selected subscriptions? <br />
      ...
      confirmText={
        mutation.isPending ? "Cancelling..." : "Cancel Subscriptions"
      }
      destructive
    />
  );
